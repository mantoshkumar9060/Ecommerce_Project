...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, PaymentCompletedEvent> paymentNotificationConsumerFactory() {
    ...
    public ConcurrentKafkaListenerContainerFactory<String, PaymentCompletedEvent> kafkaListenerContainerFactory(
            ConsumerFactory<String, PaymentCompletedEvent> paymentNotificationConsumerFactory) {
