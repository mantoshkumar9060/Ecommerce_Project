...
public final class AuthDtos {
    ...
    public record Profile(Long id, String name, String email, String mobileNumber, LocalDate dateOfBirth, String gender,
                          String role) {
    }
    ...
    public record Address(Long id, String recipientName, String mobileNumber, String line1, String line2,
                          String landmark,
                          String city, String state, String postalCode, String country, String addressType,
    ...
    public record AddressRequest(@NotBlank @Size(max = 120) String recipientName,
                                 ...
                                 @Pattern(regexp = "^\\d{6}$", message = "Pincode must be 6 digits") String postalCode,
                                 @NotBlank @Size(max = 80) String country,
                                 @Pattern(regexp = "(?i)HOME|WORK|OTHER", message = "Address type must be HOME, WORK, or OTHER") String addressType,
                                 boolean defaultAddress) {
    }
}
